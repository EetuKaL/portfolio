...
class About extends StatelessComponent {
  ...
  Component build(BuildContext context) {
    ...
    return section(id: 'about', classes: 'reveal grid md:grid-cols-2 gap-12 items-center, max-h-[90vh]', [
      div(classes: 'space-y-6', [
        h2(classes: 'text-3xl font-bold neon-text', [Component.text(s.about_title)]),
        p(classes: 'text-gray-300 leading-relaxed text-lg', [
          Component.text(s.about_p1_prefix),
          span(classes: 'text-cyan-300', [Component.text(s.about_p1_highlight)]),
        ...
        div(classes: 'glass-card p-6 rounded-2xl relative overflow-hidden group', [
          ...
          ul(classes: 'space-y-4 text-gray-400', [
            AttributeItem(title: s.attr_1_title, textContent: s.attr_1_body),
            AttributeItem(title: s.attr_2_title, textContent: s.attr_2_body),
            AttributeItem(title: s.attr_3_title, textContent: s.attr_3_body),
          ]),
        ]),
      ]),
      // Profile image
      div(classes: 'relative group flex justify-center h-full md:max-h-[80vh]', [
        // Outer glow effect
        div(
          classes:
        ...
        div(classes: 'relative w-full h-full md:max-h-[80vh] rounded-2xl overflow-hidden border-2 border-white/10', [
          img(src: 'me.jpg', alt: 'Eetu Kallioniemi', classes: 'w-full transition duration-150 h-full object-cover'),
        ]),
      ]),
    ]);
  }
