...
class About extends StatelessComponent {
  ...
  Component build(BuildContext context) {
    ...
    return section(
      id: 'about',
      classes: 'reveal grid md:grid-cols-2 gap-12 items-center md:max-h-[90vh]',
      [
        ...
        div(
          classes:
              'relative w-full h-full md:max-h-[80vh] rounded-2xl overflow-hidden border-2 border-white/10',
          [
            img(
              src: 'me.jpg',
