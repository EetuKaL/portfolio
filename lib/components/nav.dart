    ...
    return nav(
      ...
      [
        ...
        div(classes: 'hidden md:flex space-x-8 text-sm uppercase tracking-widest font-tech', [
          a(href: '#about', classes: 'nav-link', [Component.text(s.navAbout)]),
          a(href: '#skills', classes: 'nav-link', [Component.text(s.navTools)]),
          a(href: '#experience', classes: 'nav-link', [Component.text(s.navExperience)]),
          a(href: '#contact', classes: 'nav-link', [Component.text(s.navContact)]),
        ]),
